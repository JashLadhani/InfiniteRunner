...
function preload(){
  mario_running =   loadAnimation("mario img.jpg");
  mario_collided = loadAnimation("mario img.jpg");
 
  
  groundImage = loadImage("Gimg.png");
  backgroundImage = loadImage("BGIMG.jfif");
  
  cloudImage = loadImage("CIMG.png");
  
  //obstacle1 = loadImage("O1.webp");
  obstacle2 = loadImage("O2.png");
  obstacle3 = loadImage("O3.jfif");
